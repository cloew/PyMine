...
public class UpArrowButton extends MovementButton {

	public UpArrowButton(float x, float y, Level level, VertexBufferObjectManager vertexBufferObjectManager, BoundaryDelegate boundaryDelegate) {
